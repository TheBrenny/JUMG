...
public interface TileBasedMap {
	...
	/**
	 * Check if the path finder has visited the given tile. This is used for
	 * debugging the path finder.
	 * 
	 * @param x
	 *        The x coordinate of the tile that is to be checked
	 * @param y
	 *        The y coordinate of the tile that is to be checked
	 * @return True if the path finder has flagged this location as visited
	 */
	public boolean visited(int x, int y);
	
	/**
	 * Clears the visited tiles/turns them all to false.
	 */
